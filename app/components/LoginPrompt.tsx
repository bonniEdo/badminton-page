  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-20 text-center">
      <Card className="max-w-md w-full p-8">
        ...
        <p className="text-sm text-ink/70 italic tracking-[0.1em] mb-8">
          「 完成入所手續，方可解鎖完整療程。 」
        </p>
          <Button
          ...
          <Button
            ...
            className="w-full py-4 bg-sage text-ink text-[12px] tracking-[0.4em] font-bold rounded-lg border-2 border-ink shadow-[4px_4px_0_0_#1A1A1A] hover:-translate-x-[1px] hover:-translate-y-[1px] active:translate-x-[2px] active:translate-y-[2px] transition-all duration-200 flex items-center justify-center gap-2.5">

                ...
                return (
                  <div className="w-full space-y-3">
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-white text-[#06C755] border border-stone-200 text-[13px] tracking-[0.4em] font-bold rounded-full shadow-md hover:shadow-lg hover:bg-[#06C755]/5 active:scale-[0.97] transition-all duration-200 flex items-center justify-center gap-2.5"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-white text-[#000000] border border-stone-200 text-[13px] tracking-[0.4em] font-bold rounded-full shadow-md hover:shadow-lg hover:bg-stone-50 active:scale-[0.97] transition-all duration-200 flex items-center justify-center gap-2.5"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-white text-[#0866FF] border border-stone-200 text-[13px] tracking-[0.4em] font-bold rounded-full shadow-md hover:shadow-lg hover:bg-[#0866FF]/5 active:scale-[0.97] transition-all duration-200 flex items-center justify-center gap-2.5"
                    >

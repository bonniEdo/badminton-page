    ...
    <main className="min-h-dvh neu-page text-stone-700 flex flex-col font-serif">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <Card className="w-full max-w-xs flex flex-col items-center text-center p-8">
          ...
          <span className="text-[11px] tracking-[0.5em] text-[#A8B58E] font-bold uppercase mb-3">Badminton Rehab Center</span>
          ...
          <Button
            ...
            className="w-full py-4 bg-[#000000] text-white text-[13px] tracking-[0.4em] font-bold rounded-full shadow-lg shadow-[#000000]/20 hover:shadow-xl hover:shadow-[#000000]/30 hover:brightness-105 active:scale-[0.97] transition-all duration-200 flex items-center justify-center gap-2.5"
          >
            {/* Google 官方四色圖示 */}
          ...
          <Button
            ...
            className="w-full py-4 bg-white !text-[#1877F2] text-[13px] tracking-[0.4em] font-bold rounded-full shadow-lg shadow-[#06C755]/20 hover:shadow-xl hover:shadow-[#06C755]/30 hover:brightness-105 active:scale-[0.97] transition-all duration-200 flex items-center justify-center gap-2.5"
          >
